...
interface PreOpScreenProps {
  token: string;
  patient: PublicPatient;
  onComplete: () => void;
}

export default function PreOpScreen({ token, patient, onComplete }: PreOpScreenProps) {
  const {
    exercises,
    currentIndex,
    currentExercise,
  ...
  return (
    <Card className="max-w-2xl mx-auto">
      <CardHeader>
        <CardTitle className="text-2xl">Pre-OP Aufnahme</CardTitle>
        <CardDescription>
